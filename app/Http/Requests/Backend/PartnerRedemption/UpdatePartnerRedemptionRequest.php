...
namespace App\Http\Requests\Backend\PartnerRedemption;

use Illuminate\Foundation\Http\FormRequest;

class UpdatePartnerRedemptionRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('update-partnerredemption');
    }
