...
class RoleRepository extends BaseRepository
{
    ...
    public function getForDataTable()
    {
        return $this->query()
            ...
            ->leftJoin('admin', 'role_user.user_id', '=', 'admin.id')
            ...
            ->select([
                ...
                DB::raw('(SELECT COUNT(role_user.id) FROM role_user LEFT JOIN admin ON role_user.user_id = admin.id WHERE role_user.role_id = roles.id AND admin.deleted_at IS NULL) AS userCount'),
            ])
