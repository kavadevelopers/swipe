<!--Action Button-->
@if( Active::checkUriPattern( 'admin/rewardstcs' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.rewardstcs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.rewardstcs.all' ) }}
            </a>
        </li>
        @permission( 'create-rewardstc' )
            <li>
                <a href="{{ route( 'admin.rewardstcs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.rewardstcs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
