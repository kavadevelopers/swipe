<!--Action Button-->
@if( Active::checkUriPattern( 'admin/policies' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.policies.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.policies.all' ) }}
            </a>
        </li>
        @permission( 'create-policy' )
            <li>
                <a href="{{ route( 'admin.policies.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.policies.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
