<!--Action Button-->
@if( Active::checkUriPattern( 'admin/vehicles' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.vehicles.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.vehicles.all' ) }}
            </a>
        </li>
        @permission( 'create-vehicle' )
            <li>
                <a href="{{ route( 'admin.vehicles.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.vehicles.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
