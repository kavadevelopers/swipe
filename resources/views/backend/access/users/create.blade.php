    ...
    {{ Form::open(['route' => 'admin.access.user.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                {{-- User Name --}}
                <div class="form-group">
                    {{ Form::label('Designation', 'Designation', ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::text('designation', null, ['class' => 'form-control box-size', 'placeholder' => 'Designation', 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->

                {{-- Contact No --}}
                <div class="form-group">
                    {{ Form::label('contact_no', 'Contact No', ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::text('contact_no', null, ['class' => 'form-control box-size', 'placeholder' => 'Contact No', 'required' => 'required']) }}
                    </div>
                </div>
