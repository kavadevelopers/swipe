<!--Action Button-->
@if( Active::checkUriPattern( 'admin/userpricings' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.userpricings.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.userpricings.all' ) }}
            </a>
        </li>
        @permission( 'create-userpricing' )
            <li>
                <a href="{{ route( 'admin.userpricings.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.userpricings.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
