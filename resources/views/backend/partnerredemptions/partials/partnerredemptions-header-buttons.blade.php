<!--Action Button-->
@if( Active::checkUriPattern( 'admin/partnerredemptions' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.partnerredemptions.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.partnerredemptions.all' ) }}
            </a>
        </li>
        @permission( 'create-partnerredemption' )
            <li>
                <a href="{{ route( 'admin.partnerredemptions.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.partnerredemptions.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
