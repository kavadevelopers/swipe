<!--Action Button-->
@if( Active::checkUriPattern( 'admin/liabilities' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.liabilities.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.liabilities.all' ) }}
            </a>
        </li>
        @permission( 'create-liability' )
            <li>
                <a href="{{ route( 'admin.liabilities.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.liabilities.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
