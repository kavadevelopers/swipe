<!--Action Button-->
@if( Active::checkUriPattern( 'admin/partnerfaqs' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.partnerfaqs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.partnerfaqs.all' ) }}
            </a>
        </li>
        @permission( 'create-partnerfaq' )
            <li>
                <a href="{{ route( 'admin.partnerfaqs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.partnerfaqs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
