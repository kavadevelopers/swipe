...
@section ('title', trans('User Rewards'))

@section('page-header')
    <h1>{{ trans('User Rewards') }}</h1>
@endsection

@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('User Rewards') }}</h3>
    ...
    <script>
        ...
        $(function() {
            ...
            var dataTable = $('#expenditures-table').dataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route("admin.expenditures.getuserreward") }}',
                    type: 'post'
                },
                columns: [
