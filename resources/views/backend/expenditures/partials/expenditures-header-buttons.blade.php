<!--Action Button-->
@if( Active::checkUriPattern( 'admin/expenditures' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.expenditures.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.expenditures.all' ) }}
            </a>
        </li>
        @permission( 'create-expenditure' )
            <li>
                <a href="{{ route( 'admin.expenditures.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.expenditures.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
