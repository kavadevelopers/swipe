<div class="form-group">
    ...
    <div class="form-group">
        {{ Form::label('partner_price', trans('Price'), ['class' => 'col-lg-2 control-label required']) }}

        <div class="col-lg-10">
            {{ Form::text('partner_price', null, ['class' => 'form-control box-size', 'placeholder' => trans('validation.attributes.backend.faqs.question'), 'required' => 'required']) }}
        </div><!--col-lg-10-->
    </div><!--form control-->
