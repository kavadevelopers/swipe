<!--Action Button-->
@if( Active::checkUriPattern( 'admin/partnerpricings' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.partnerpricings.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.partnerpricings.all' ) }}
            </a>
        </li>
        @permission( 'create-partnerpricing' )
            <li>
                <a href="{{ route( 'admin.partnerpricings.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.partnerpricings.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
